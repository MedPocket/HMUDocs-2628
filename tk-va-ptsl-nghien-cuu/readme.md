...
> Tổng hợp và chuẩn hóa theo chương trình giảng dạy Thống kê Y học - Tin học ứng dụng (HPMU, HMU) và Giáo trình Phân tích Thống kê Cơ bản trong Quản lý bằng SPSS.

---

## 📌 Mục Mục Toàn Bộ Giáo Trình

### 📘 [Chương 1: Tổng quan về SPSS và Quản lý Nhập dữ liệu Nghiên cứu](chuong-1-tong-quan-va-nhap-lieu-spss.md)
...
### 📘 [Chương 2: Quản lý và Biến đổi Dữ liệu trong SPSS](chuong-2-quan-ly-va-bien-doi-du-lieu.md)
...
### 📘 [Chương 3: Thống kê Mô tả và Trình bày Dữ liệu Nghiên cứu](chuong-3-thong-ke-mo-ta-va-trinh-bay-du-lieu.md)
...
4. **Mô tả mối quan hệ giữa 2 biến số**:
   - Biến định tính x Biến định tính: Lệnh `Crosstabs`, Bảng $2 \times 2$ & $n \times m$, Biểu đồ Stacked Bar
...
### 📘 [Chương 4: Kiểm định Giả thuyết về Giá trị Trung bình](chuong-4-kiem-dinh-gia-thiet-trung-binh.md)
1. **Cơ sở lý thuyết kiểm định giả thuyết thống kê**: Giả thuyết $H_0, H_a$, Mức ý nghĩa $\alpha$, Giá trị $p$-value
...
### 📘 [Chương 5: Kiểm định Giả thuyết cho Biến Định tính và Tỷ lệ](chuong-5-kiem-dinh-ty-le-va-bien-dinh-tinh.md)
1. **Kiểm định giả thuyết cho 1 giá trị tỷ lệ**: Kiểm định nhị thức `Binomial Test`
2. **Kiểm định mối liên quan giữa 2 biến định tính độc lập**: `Chi-Square Test` ($\chi^2$)
   - Bảng $2 \times 2$: Đọc kết quả `Pearson Chi-Square`, `Continuity Correction`, hoặc `Fisher's Exact Test`
   - Bảng $n \times m$: Điều kiện số ô có tần số kỳ vọng (Expected Count) $< 5$ không vượt quá $20\%$
3. **Đánh giá mức độ liên quan và nguy cơ**:
   - Tỷ số chênh (`Odds Ratio - OR`) và Nguy cơ tương đối (`Relative Risk - RR`)
   - Khoảng tin cậy 95% ($95\% \text{ CI}$)
4. **Kiểm định giả thuyết cho 2 tỷ lệ ghép cặp**: Kiểm định `McNemar Test`

---

### 📘 [Chương 6: Phân tích Tương quan và Hồi quy Thống kê](chuong-6-tuong-quan-va-hoi-quy.md)
